...
# ---------------------------------------------------------------------------
# Session-scoped event loop + table creation
# ---------------------------------------------------------------------------
...
dest = pathlib.Path(__file__).parent / "tests" / "conftest.py"
dest.write_text(CONFTEST, encoding="utf-8")
print("conftest.py written:", dest)
